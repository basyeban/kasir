                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <x-text-input id="name" class="block mt-1 w-full bg-gray-50 border-gray-200 focus:bg-white transition-colors" type="text" name="name" :value="old('name')" required autofocus placeholder="Masukkan nama produk..." />
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="price" class="block mt-1 w-full bg-gray-50 border-gray-200 focus:bg-white transition-colors" type="number" name="price" :value="old('price')" required placeholder="0" />
                                        <x-input-error :messages="$errors->get('price')" class="mt-2" />
                                    </div>
                                    <div>
                                        <x-input-label for="stock" :value="__('Stok Awal')" class="font-bold text-gray-700 uppercase tracking-wider text-xs" />
                                        <x-text-input id="stock" class="block mt-1 w-full bg-gray-50 border-gray-200 focus:bg-white transition-colors" type="number" name="stock" :value="old('stock')" required placeholder="0" />
                            ...
                            <div class="space-y-6">
                                <div>
                                    <x-input-label for="image" :value="__('Foto Produk')" class="font-bold text-gray-700 uppercase tracking-wider text-xs mb-1" />
                                    ...
                                    <div id="image-preview" class="mt-4 hidden">
                                        <p class="text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Preview:</p>
                                        <img id="preview-img" class="h-40 w-full object-cover rounded-lg border border-gray-100 shadow-sm">
                                    </div>
